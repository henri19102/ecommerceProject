    ...
    <Box>
      <Grid container spacing={3}>
        ...
        <Grid item xs={6}>
          <Paper className={classes.paper}>
            ...
            <p>
              ...
              eye, but can you change everything?. It&apos;s great, can you
              add a beard though jazz it up a little, yet can you lower the
              price for the website? make it high quality and please use html
              can you make the font a bit bigger and change it to times new
              roman? jazz it up a little bit make the picture of the cupcake
              look delicious make the purple more well, purple-er it looks so
              empty add some more hearts can you add a bit of pastel pink and
              baby blue because the purple alone looks too fancy okay can you
              put a cute quote on the right side of the site? oh no it looks
              messed up! i think we need to start from scratch. Can you make it
              pop can you put &quot;find us on facebook&quot; by the
              facebook logo? Jazz it up a little. That&apos;s great, but we
              need to add this 2000 line essay. Can you make it stand out more?.
        ...
        <Grid item xs={6}>
          ...
          <Divider />
          <Paper className={classes.paper}>GoogleMaps Here?</Paper>
        </Grid>
      </Grid>
    </Box>
  );
